...
const generateSVG = (text, textColor, shape, shapeColor) => {
  ...
  const svgCode = `<svg width="300" height="200" version="1.1" xmlns="http://www.w3.org/2000/svg">${shapeCode}fill = "${shapeColor}"<text x="150" y="130" font-size="50" text-anchor="middle" fill="${textColor}">${text}</text></svg>`;
  return svgCode;
};
